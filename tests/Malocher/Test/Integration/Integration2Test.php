...
use Malocher\Test\Integration\Integration2\Integration2Bus;
use Malocher\Test\Integration\Integration2\Integration2Command;
use Malocher\Test\Integration\Integration2\Integration2Event;
use Malocher\Test\Integration\Integration2\Integration2Handler;
...
class Integration2Test extends TestCase
{
    ...
    {
        $this->adapter->pipe($this->bus, array('Malocher\Test\Integration\Integration2\Integration2Handler'));
        ...
        $command->callback = function (Integration2Handler $returnedHandler, Integration2Command $returnedCommand, $returnedCommandIsEdited) {
            $this->assertInstanceOf('Malocher\Test\Integration\Integration2\Integration2Handler', $returnedHandler);
            $this->assertInstanceOf('Malocher\Test\Integration\Integration2\Integration2Command', $returnedCommand);
    ...
    public function test2()
    {
        ...
        $event->callback = function (Integration2Handler $returnedHandler, Integration2Event $returnedEvent, $returnedEventIsEdited) {
            $this->assertInstanceOf('Malocher\Test\Integration\Integration2\Integration2Handler', $returnedHandler);
            $this->assertInstanceOf('Malocher\Test\Integration\Integration2\Integration2Event', $returnedEvent);
