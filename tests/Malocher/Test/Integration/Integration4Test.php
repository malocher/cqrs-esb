...
use Malocher\Test\Integration\Integration4\Integration4Command;
use Malocher\Test\Integration\Integration4\Integration4Event;
        ...
        $configuration = [
            'adapters' => [
                'Malocher\Cqrs\Adapter\ArrayMapAdapter' => [
                    'buses' => [
                        'Malocher\Test\Integration\Integration4\Integration4Bus' => [
                            'Malocher\Test\Integration\Integration4\Integration4Command' => [
                                'alias' => 'Malocher\Test\Integration\Integration4\Integration4CommandHandler',
        ...
        $configuration = array(
            'adapters' => array(
                'Malocher\Cqrs\Adapter\ArrayMapAdapter' => array(
                    'buses' => array(
                        'Malocher\Test\Integration\Integration4\Integration4Bus' => array(
                            'Malocher\Test\Integration\Integration4\Integration4Event' => function (Integration4Event $event) {
                                $event->edit();
                            }
                        )
                    )
