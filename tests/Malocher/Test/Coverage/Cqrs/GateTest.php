 ...
 */
namespace Malocher\Test\Coverage\Cqrs;
...
use Malocher\Test\Coverage\Mock\Bus\MockFakeSystemBus;
 ...
 * @package Malocher\Test\Coverage\Cqrs
 */
class GateTest extends TestCase
{
    ...
    public function testGetBus_DefaultBusSet()
    {
        ...
        $anotherBus = new \Malocher\Test\Coverage\Mock\Bus\MockAnotherBus(
            new ClassMapCommandHandlerLoader(),
            new ClassMapEventListenerLoader(),
            new ClassMapQueryHandlerLoader()
        );
