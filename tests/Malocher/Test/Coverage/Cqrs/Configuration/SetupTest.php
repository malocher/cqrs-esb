 ...
 */
namespace Malocher\Test\Coverage\Cqrs\Configuration;
...
use Malocher\Test\Coverage\Mock\Command\MockCommandMonitor;
 ...
 * @package Malocher\Test\Coverage\Cqrs\Configuration
 */
class SetupTest extends TestCase
{
    ...
    public function testInitialize()
    {
        ...
        $this->assertEquals('Malocher\Test\Coverage\Mock\Command\MockCommand', $invokeCommandCommand->getMessageClass());
        $this->assertEquals('Malocher\Test\Coverage\Mock\Command\MockCommand', $commandInvokedEvent->getMessageClass());
