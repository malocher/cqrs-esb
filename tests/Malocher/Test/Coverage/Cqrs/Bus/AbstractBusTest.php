...
class AbstractBusTest extends TestCase implements BusInterfaceTest
{
    ...
    {
        $this->bus->mapQuery('Malocher\Test\Coverage\Mock\Query\MockQuery', function (QueryInterface $query) {
        });
        $this->assertNotNull($this->bus->getQueryHandlerMap()['Malocher\Test\Coverage\Mock\Query\MockQuery']);
    }
    ...
    public function testExecuteQueryHandlerAnnotationAdapter()
    {
        ...
        $adapter->pipe($this->bus, array('Malocher\Test\Coverage\Mock\Query\MockCallbackQueryHandler'));
        $mockQuery = new MockQuery();
    ...
    public function testExecuteQueryHandlerNoAdapter()
    {
        ...
        $this->bus->setGate(new Gate());
        $adapter = new AnnotationAdapter();
        $adapter->pipe($this->bus, array('Malocher\Test\Coverage\Mock\Query\MockQueryHandlerNoAdapter'));
        $mockQuery = new MockQuery();
        $mockQuery->callback = function ($isEdited) {
        };
        $result = $this->bus->executeQuery($mockQuery);
    ...
    {
        $this->bus->mapCommand('Malocher\Test\Coverage\Mock\Command\MockCommand', function (CommandInterface $command) {
        });
        $this->assertNotNull($this->bus->getCommandHandlerMap()['Malocher\Test\Coverage\Mock\Command\MockCommand']);
    }
    ...
    public function testInvokeCommandHandlerAnnotationAdapter()
    {
        $this->bus->setGate(new Gate());
        $adapter = new AnnotationAdapter();
        $adapter->pipe($this->bus, array('Malocher\Test\Coverage\Mock\Command\MockCallbackCommandHandler'));
        $mockCommand = new MockCommand();
    ...
    public function testInvokeCommandHandlerNoAdapter()
    {
        ...
        $this->bus->setGate(new Gate());
        $adapter = new AnnotationAdapter();
        $adapter->pipe($this->bus, array('Malocher\Test\Coverage\Mock\Command\MockCommandHandlerNoAdapter'));
        $mockCommand = new MockCommand();
        $mockCommand->callback = function ($isEdited) {
        };
        $this->bus->invokeCommand($mockCommand);
    ...
    {
        $this->bus->registerEventListener('Malocher\Test\Coverage\Mock\Event\MockEvent', function (EventInterface $event) {
        });
        $this->assertNotNull($this->bus->getEventListenerMap()['Malocher\Test\Coverage\Mock\Event\MockEvent']);
    }
    ...
    public function testPublishEventHandlerAnnotationAdapter()
    {
        $this->bus->setGate(new Gate());
        $adapter = new AnnotationAdapter();
        $adapter->pipe($this->bus, array('Malocher\Test\Coverage\Mock\Event\MockCallbackEventHandler'));
        $mockEvent = new MockEvent();
    ...
    public function testPublishEventHandlerNoAdapter()
    {
        ...
        $this->bus->setGate(new Gate());
        $adapter = new AnnotationAdapter();
        $adapter->pipe($this->bus, array('Malocher\Test\Coverage\Mock\Event\MockEventHandlerNoAdapter'));
        $mockEvent = new MockEvent();
        $mockEvent->callback = function ($isEdited) {
        };
        $this->bus->publishEvent($mockEvent);
