 ...
 */
namespace Malocher\Test\Coverage\Cqrs\Event;
 ...
 * @package Malocher\Test\Coverage\Cqrs\Event
 */
class ClassMapEventListenerLoaderTest extends TestCase implements EventListenerLoaderInterfaceTest
{
    ...
    {
        $alias = 'Malocher\Test\Coverage\Mock\Event\MockEvent';
        $listener = $this->loader->getEventListener($alias);
        $this->assertInstanceOf('Malocher\Test\Coverage\Mock\Event\MockEvent', $listener);
    }

    public function testGetNonExistingEventListener()
    {
        $this->setExpectedException('Malocher\Cqrs\Event\EventException');
        $alias = 'Malocher\Test\Coverage\Mock\Event\NotExisting_MockEvent';
