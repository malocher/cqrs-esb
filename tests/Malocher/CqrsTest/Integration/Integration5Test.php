...
use Malocher\CqrsTest\Integration\Integration5\Integration5Command;
use Malocher\CqrsTest\Integration\Integration5\Integration5Event;
        ...
        $configuration = array(
            'adapters' => array(
                'Malocher\Cqrs\Adapter\AnnotationAdapter' => array(
                    'buses' => array(
                        'Malocher\CqrsTest\Integration\Integration5\Integration5Bus' => array(
                            'Malocher\CqrsTest\Integration\Integration5\Integration5Handler'
                        )
                    )
                ),
            ),
