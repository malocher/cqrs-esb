...
use Malocher\CqrsTest\Integration\Integration3\Integration3Bus;
use Malocher\CqrsTest\Integration\Integration3\Integration3Command;
use Malocher\CqrsTest\Integration\Integration3\Integration3Event;
use Malocher\CqrsTest\Integration\Integration3\Integration3EventListener;
use Malocher\CqrsTest\Integration\Integration3\Integration3EventListenerLoader;
use Malocher\CqrsTest\Integration\Integration3\Integration3InvokableEventListener;
...
class Integration3Test extends TestCase
{
    ...
    {
        $this->bus->mapCommand(
            'Malocher\CqrsTest\Integration\Integration3\Integration3Command',
            array(
                'alias' => 'Malocher\CqrsTest\Integration\Integration3\Integration3CommandHandler',
    ...
    public function testPublishEvent__withEventListenerDefinition()
    {
        $this->bus->registerEventListener(
            'Malocher\CqrsTest\Integration\Integration3\Integration3Event',
            array(
    ...
    public function testPublishEvent__withInvokableEventListener()
    {
        ...
        $this->bus->registerEventListener('Malocher\CqrsTest\Integration\Integration3\Integration3Event', $Integration3InvokableEventListener);
        $Integration3Event = new Integration3Event(array('message' => 'it works'));
        $this->bus->publishEvent($Integration3Event);
        $this->assertEquals(
            'it works',
