...
class AbstractBusTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->object = new Mock\Bus\BusMock($classMapCommandHandlerLoader, $this->mockEventListenerLoader);
    ...
    {
        $this->object->registerEventListener(
        ...
        $this->object->publishEvent($mockEvent);
    ...
    public function testPublishEvent__withInvokableEventListener() {
        ...
        $this->object->registerEventListener('Test\Mock\Event\MockEvent', $invokableEventListener);
